    ...
    public static class ConfigurationBuilderExtensions
    {
        ...
        public static IConfigurationBuilder AddJsonConfigs(this IConfigurationBuilder manager)
        {
            ...
            return manager
                ...
                .AddJsonFile(Path.Combine(ConfigsDirectory, $"{nameof(KlaytnscopeSettings).ToLower()}.json"), false, true)
                .AddJsonFile(Path.Combine(ConfigsDirectory, $"{nameof(KlaytnscopeSettings).ToLower()}.{env}.json"), true, true);
        }
    }
}